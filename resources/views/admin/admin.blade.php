...
<head>
	...
	<title>Admin - Enghlish For Future</title>
				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Hello Admin</h2>
								<h5 class="text-white op-7 mb-2">Chào mừng bạn đến với trang quản lý</h5>
							</div>
												...
												<table class="table">
													<tbody>
														<tr>
															<td>
																<div class="flag">
																	<img src="{{asset('public/admin/img/flags/id.png')}}" alt="indonesia">
																</div>
															</td>
															<td>Indonesia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="{{asset('public/admin/img/flags/us.png')}}" alt="united states">
																</div>
															</td>
															<td>USA</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="{{asset('public/admin/img/flags/au.png')}}" alt="australia">
																</div>
															</td>
															<td>Australia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="{{asset('public/admin/img/flags/ru.png')}}" alt="russia">
																</div>
															</td>
															<td>Russia</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="{{asset('public/admin/img/flags/cn.png')}}" alt="china">
																</div>
															</td>
															<td>China</td>
															<td class="text-right">
														...
														<tr>
															<td>
																<div class="flag">
																	<img src="{{asset('public/admin/img/flags/br.png')}}" alt="brazil">
																</div>
															</td>
															<td>Brasil</td>
															<td class="text-right">
						...
						<div class="col-md-4">
							<div class="card">
								...
								<div class="card-body pb-0">
									<div class="d-flex">
										<div class="avatar">
											<img src="{{asset('public/admin/img/logoproduct.svg')}}" alt="..." class="avatar-img rounded-circle">
										</div>
									...
									<div class="d-flex">
										<div class="avatar">
											<img src="{{asset('public/admin/img/logoproduct3.svg')}}" alt="..." class="avatar-img rounded-circle">
										</div>
										<div class="flex-1 pt-1 ml-2">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="card-list">
										<div class="item-list">
											<div class="avatar">
												<img src="{{asset('public/admin/img/jm_denis.jpg')}}" alt="..." class="avatar-img rounded-circle">
											</div>
										...
										<div class="item-list">
											<div class="avatar">
												<img src="{{asset('public/admin/img/chadengle.jpg')}}" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="{{asset('public/admin/img/talha.jpg')}}" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
										...
										<div class="item-list">
											<div class="avatar">
												<img src="{{asset('public/admin/img/mlane.jpg')}}" alt="..." class="avatar-img rounded-circle">
											</div>
											<div class="info-user ml-3">
