                        ...
                        <form class="form-horizontal" method="post" action="#">
                            ...
                            <div class="form-group">
                               ...
                               <div class="cols-sm-10">
                                  <div class="input-group">
                                     <input type="text" class="form-control" name="username" id="username" placeholder="Enter Username" value="{{$data_user->username}}"/>
                                  </div>
                               </div>
                            </div>
                            <div class="form-group">
                               ...
                               <div class="cols-sm-10">
                                  <div class="input-group">
                                     <input type="email" class="form-control" name="email" id="email" placeholder="Enter Email" value="{{$data_user->email}}"/>
                                  </div>
                               </div>
                            </div>
                            <div class="form-group">
                               ...
                               <div class="cols-sm-10">
                                  <div class="input-group">
                                     <input type="text" class="form-control" name="first_name" id="first_name" placeholder="Enter First name" value="{{$data_user->first_name}}"/>
                                  </div>
                               </div>
                            </div>
                            <div class="form-group">
                               ...
                               <div class="cols-sm-10">
                                  <div class="input-group">
                                     <input type="text" class="form-control" name="last_name" id="last_name" placeholder="Enter Last Name" value="{{$data_user->last_name}}"/>
                                  </div>
                               </div>
                            </div>
                            <div class="form-group">
                               ...
                               <div class="cols-sm-10">
                                  <div class="input-group">
                                     <input type="date" class="form-control" name="birthday" id="birthday" placeholder="Enter Birthday" value="{{$data_user->birthday}}"/>
                                  </div>
                               </div>
                            </div>
                            <div class="form-group">
                               ...
                               <div class="cols-sm-10">
                                  <div class="input-group">
                                     <input type="tel" class="form-control" name="phone" id="phone" placeholder="Enter Phone" value="{{$data_user->phone}}"/>
                                  </div>
                               </div>
                            </div>
                            <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    <div style="display: flex; margin-top: 10px">
                                        <div style="display: flex; align-items: center" class="form-check">
                                            <input style="width: 20px; height: 20px" class="form-check-input" type="radio" name="sex" value="{{$data_user->sex}}"
                                                   id="display"checked />
                                            <label style="
                                        ...
                                        <div style="
                                          ...
                                          margin-left: 30px;
                                          " class="form-check">
                                            <input style="width: 20px; height: 20px" class="form-check-input" type="radio" value="{{$data_user->sex}}" name="sex"
                                                   id="display1"  />
                                            <label style="
                                             font-family: 'Montserrat';
                                             font-style: normal;
                           ...
                           <div class="form-group pull-right">
                               <a href="{{asset('admin/user')}}" style="color: white" type="submit" class="btn btn-danger ">Hủy</a>
                               <button style="color: white" type="submit" class="btn btn-primary ">Cập nhật</button>
                           </div>
                        </form>
                     </div>
                  </div>
