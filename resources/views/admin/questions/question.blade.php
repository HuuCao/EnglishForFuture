    ...
    <script>
        WebFont.load({
            ...
            custom: {
                ...
                urls: [{{ asset('public/admin/css/fonts.min.css') }}]
            },
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                                ...
                                <li>
                                    <div class="message-notif-scroll scrollbar-outer">
                                        <div class="notif-center">
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img src="{{ asset('public/admin/img/jm_denis.jpg') }}"
                                                        alt="Img Profile">
                                                </div>
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img src="{{ asset('public/admin/img/chadengle.jpg') }}"
                                                        alt="Img Profile">
                                                </div>
                                                <div class="notif-content">
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img src="{{ asset('public/admin/img/mlane.jpg') }}"
                                                        alt="Img Profile">
                                                </div>
                                                <div class="notif-content">
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img src="{{ asset('public/admin/img/talha.jpg') }}"
                                                        alt="Img Profile">
                                                </div>
                                                <div class="notif-content">
                                ...
                                <li>
                                    <div class="notif-scroll scrollbar-outer">
                                        <div class="notif-center">
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img src="{{ asset('public/admin/img/profile2.jpg') }}"
                                                        alt="Img Profile">
                                                </div>
                                                <div class="notif-content">
                                                    <span class="block">
                        ...
                        <li class="nav-item dropdown hidden-caret">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"
                                aria-expanded="false">
                                <div class="avatar-sm">
                                    <img src="{{ asset('public/admin/img/profile.jpg') }}" alt="..."
                                    ...
                                    <li>
                                        <div class="user-box">
                                            <div class="avatar-lg"><img
                                                    src="{{ asset('public/admin/img/profile.jpg') }}"
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="button-add">
                                    <a href="{{ asset('admin/question/add') }}" type="button"
                                        class="btn btn-primary pull-right mr-3 mt-3">Upload câu hỏi</a>
                                </div>
                                <div class="card-body">
                                                ...
                                                @foreach ($data_question as $question)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 200px; text-align: center;">
                                                            <img style="width: 50%; margin-top: 4px; margin-bottom: 4px;"
                                                                src="{{ $question->image }}">
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="form-button-action">
                                                                <a type="submit" data-toggle="tooltip"
                                                                    href="{{ asset('admin/question/edit/' . $question->id) }}"
                                                                    name="edit" value="Edit" title=""
                                                                    class="btn btn-link btn-primary btn-lg"
                                                                    data-original-title="Edit Question">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>
                                                                <a type="submit" data-toggle="tooltip"
                                                                    href="{{ asset('admin/question/delete/' . $question->id) }}"
                                                                    name="delete" value="Delete" title=""
