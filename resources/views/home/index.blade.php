...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
    ...
    <div class="hero-slide owl-carousel site-blocks-cover">
      <div class="intro-section" style="background-image: url('{{asset('public/home/images/hero_1.jpg')}}');">
        <div class="container">
          <div class="row align-items-center">
        ...
        <div class="row">
          <div class="col-12">
              <div class="owl-slide-3 owl-carousel">
                  ...
                  <div class="course-1-item">
                    <figure class="thumnail">
                      <a href="course-single.html"><img src="{{asset('public/home/images/course_2.jpg')}}" alt="Image" class="img-fluid"></a>
                      <div class="price">$99.00</div>
                  ...
                  <div class="course-1-item">
                    <figure class="thumnail">
                      <a href="course-single.html"><img src="{{asset('public/home/images/course_3.jpg')}}" alt="Image" class="img-fluid"></a>
                      <div class="price">$99.00</div>
                  ...
                  <div class="course-1-item">
                    <figure class="thumnail">
                        <a href="course-single.html"><img src="{{asset('public/home/images/course_4.jpg')}}" alt="Image" class="img-fluid"></a>
                      <div class="price">$99.00</div>
                      <div class="category"><h3>Mobile Application</h3></div>  
                    </figure>
                    <div class="course-1-content pb-4">
                  ...
                  <div class="course-1-item">
                    <figure class="thumnail">
                        <a href="course-single.html"><img src="{{asset('public/home/images/course_5.jpg')}}" alt="Image" class="img-fluid"></a>
                      <div class="price">$99.00</div>
                      <div class="category"><h3>Web Design</h3></div>  
                    </figure>
                    <div class="course-1-content pb-4">
                  ...
                  <div class="course-1-item">
                    <figure class="thumnail">
                        <a href="course-single.html"><img src="{{asset('public/home/images/course_6.jpg')}}" alt="Image" class="img-fluid"></a>
                      <div class="price">$99.00</div>
                      <div class="category"><h3>Mobile Application</h3></div>  
                    </figure>
                    <div class="course-1-content pb-4">
    ...
    <div class="section-bg style-1" style="background-image: url('{{asset('public/home/images/about_1.jpg')}}');">
      <div class="container">
        <div class="row">
          <div class="col-lg-4">
  ...
  <div class="site-section">
        ...
        <div class="owl-slide owl-carousel">
          ...
          <div class="ftco-testimonial-1">
            <div class="ftco-testimonial-vcard d-flex align-items-center mb-4">
              <img src="{{asset('public/home/images/person_1.jpg')}}" alt="Image" class="img-fluid mr-3">
              <div>
          ...
          <div class="ftco-testimonial-1">
            <div class="ftco-testimonial-vcard d-flex align-items-center mb-4">
              <img src="{{asset('public/home/images/person_2.jpg')}}" alt="Image" class="img-fluid mr-3">
              <div>
                <h3>Allison Holmes</h3>
                <span>Designer</span>
              </div>
          ...
          <div class="ftco-testimonial-1">
            <div class="ftco-testimonial-vcard d-flex align-items-center mb-4">
              <img src="{{asset('public/home/images/person_4.jpg')}}" alt="Image" class="img-fluid mr-3">
              <div>
                <h3>Allison Holmes</h3>
                <span>Designer</span>
              </div>
          ...
          <div class="ftco-testimonial-1">
            <div class="ftco-testimonial-vcard d-flex align-items-center mb-4">
              <img src="{{asset('public/home/images/person_3.jpg')}}" alt="Image" class="img-fluid mr-3">
              <div>
                <h3>Allison Holmes</h3>
                <span>Designer</span>
              </div>
    ...
    <div class="section-bg style-1" style="background-image: url('{{asset('public/home/images/hero_1.jpg')}}');">
      <div class="container">
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="post-entry-big">
                  <a href="news-single.html" class="img-link"><img src="{{asset('public/home/images/blog_large_1.jpg')}}" alt="Image" class="img-fluid"></a>
              ...
              <div class="col-lg-6">
                <div class="post-entry-big horizontal d-flex mb-4">
                  <a href="news-single.html" class="img-link mr-4"><img src="{{asset('public/home/images/blog_1.jpg')}}" alt="Image" class="img-fluid"></a>
                  <div class="post-content">
                    <div class="post-meta">
                      <a href="#">June 6, 2019</a>
                      <span class="mx-1">/</span>
                ...
                <div class="post-entry-big horizontal d-flex mb-4">
                  <a href="news-single.html" class="img-link mr-4"><img src="{{asset('public/home/images/blog_2.jpg')}}" alt="Image" class="img-fluid"></a>
                  <div class="post-content">
                    <div class="post-meta">
                      <a href="#">June 6, 2019</a>
                      <span class="mx-1">/</span>
          ...
          <div class="col-lg-3">
            ...
            <a href="https://vimeo.com/45830194" class="video-1 mb-4" data-fancybox="" data-ratio="2">
              ...
              <img src="{{asset('public/home/images/course_5.jpg')}}" alt="Image" class="img-fluid">
            </a>
            <a href="https://vimeo.com/45830194" class="video-1 mb-4" data-fancybox="" data-ratio="2">
                <span class="play">
                  <span class="icon-play"></span>
    ...
    <div class="site-section ftco-subscribe-1" style="background-image: url('{{asset('public/home/images/bg_1.jpg')}}')">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-7">
